...
public class TransferFailedEvent extends Event<TransferFailedEvent.TransferFailedEventEventPayload> {

  public static final String EVENT_TYPE = "transfer-failed";

  public TransferFailedEvent(@NonNull String eventType, @NonNull String createdAt, @NonNull TransferFailedEventEventPayload payload) {
