...
import it.reply.orchestrator.service.commands.GetMonitoringData;
...
public class GetMonitoringDataCommandTest
    extends BaseRankCloudProviderCommandTest<GetMonitoringData> {
  ...
  @Override
  protected GetMonitoringData getCommand() {
    return getMonitoringDataCommand;
  }

  @Test
  public void doexecuteSuccesfully() throws Exception {

    RankCloudProvidersWorkflowTest.mockMonitoring(mockServer, monitoringProperties.getUrl());
